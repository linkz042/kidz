...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get(f'{tan}://{iya}.com/{ani}/vip1/blob/main/a.txt').text
  ...
  try:
    httpCaht = requests.get(f"{tan}://{iya}.com/{ani}/vip1/blob/main/a.txt").text
    if id in httpCaht:
